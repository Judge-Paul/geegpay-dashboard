  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-0 mb-10 space-y-4 px-6">
        ...
        <Button className={cn(!isOpen && "hidden", "w-36")} variant="ghost">
          <svg
            className="hover:cursor-pointer"
            xmlns="http://www.w3.org/2000/svg"
            width="24"
          ...
          {isOpen && (
            <span className={cn("ml-3 flex w-24 justify-between text-base")}>
              Settings
            </span>
          )}
        </Button>
        <svg
          className={cn(isOpen && "hidden", "hover:cursor-pointer")}
          xmlns="http://www.w3.org/2000/svg"
          width="24"
          height="24"
          fill="none"
        ...
        <AlertDialog>
          <AlertDialogTrigger asChild className="flex">
            <Button variant="ghost" className={cn(!isOpen && "hidden", "w-36")}>
              <svg
                className="hover:cursor-pointer"
                xmlns="http://www.w3.org/2000/svg"
                width="24"
